...
public class Site extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barr = (ProgressBar)findViewById(R.id.progressbarsite);

        OurBrow=(WebView) findViewById(R.id.webviewsite);
        OurBrow.setWebViewClient(new MyBrowser());
        OurBrow.setWebViewClient(new Myb());
        OurBrow.getSettings().setJavaScriptEnabled(true);
        OurBrow.loadUrl("http://ww4.msu.ac.zw");
    }
